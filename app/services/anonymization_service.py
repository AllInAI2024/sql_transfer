...
class SQLAnonymizer:
    ...
    def _get_keywords(self) -> Set[str]:
        dialect_keywords = self._get_dialect_specific_keywords()
        return ALL_SQL_KEYWORDS.union(self.RESERVED_KEYWORDS).union(dialect_keywords)
    
    def _get_dialect_specific_keywords(self) -> Set[str]:
        dialect_specific = {
            "mysql": {
                "LIMIT", "OFFSET", "AUTO_INCREMENT", "ENGINE", "CHARSET", "COLLATE",
                "UNSIGNED", "ZEROFILL", "AUTO_INCREMENT", "IDENTIFIED", "PASSWORD",
                "LOW_PRIORITY", "HIGH_PRIORITY", "DELAYED", "IGNORE", "FORCE",
                "STRAIGHT_JOIN", "SQL_CALC_FOUND_ROWS", "SQL_BIG_RESULT",
                "SQL_SMALL_RESULT", "SQL_BUFFER_RESULT", "SQL_CACHE", "SQL_NO_CACHE",
                "PROCEDURE", "ANALYSE", "INTO", "OUTFILE", "DUMPFILE", "FIELDS",
                "COLUMNS", "ESCAPED", "ENCLOSED", "TERMINATED", "OPTIONALLY",
                "LINES", "STARTING", "CHARACTER", "SET", "NAMES", "DUAL",
                "REGEXP", "RLIKE", "BINARY", "MATCH", "AGAINST", "BOOLEAN", "MODE",
                "TRUE", "FALSE", "XA", "START", "COMMIT", "ROLLBACK", "SAVEPOINT",
                "RELEASE", "ROLLBACK", "TO", "LOCK", "UNLOCK", "TABLES", "FLUSH",
                "RESET", "KILL", "PURGE", "BINARY", "LOGS", "MASTER", "SLAVE",
                "RESET", "START", "STOP", "CHANGE", "GRANT", "REVOKE", "PRIVILEGES",
                "EVENT", "SCHEDULE", "EVERY", "AT", "ENABLE", "DISABLE", "ON",
                "COMPLETION", "PRESERVE", "DO", "CASE", "WHEN", "THEN", "ELSE",
                "ELSEIF", "END", "IF", "WHILE", "LOOP", "REPEAT", "UNTIL", "LEAVE",
                "ITERATE", "RETURN", "LEAVE", "ITERATE", "OPEN", "FETCH", "CLOSE",
                "DECLARE", "HANDLER", "CONTINUE", "EXIT", "UNDO", "NOT", "FOUND",
                "SQLEXCEPTION", "SQLWARNING", "SQLSTATE", "SIGNAL", "RESIGNAL",
                "PREPARE", "EXECUTE", "DEALLOCATE", "USING", "DELIMITER"
            },
            "oracle": {
                "ROWNUM", "ROWID", "LEVEL", "CONNECT", "PRIOR", "START", "NOCYCLE",
                "SYSDATE", "SYSTIMESTAMP", "DBTIMEZONE", "SESSIONTIMEZONE",
                ...
                "TEMPORARY", "PERMANENT", "TABLESPACE", "DATAFILE",
                "SCHEMA", "ROLE", "PUBLIC", "GRANT", "REVOKE", "IDENTIFIED",
                "PRIVILEGES", "WITH", "ADMIN", "OPTION", "PROFILE", "QUOTA",
                "UNLIMITED", "PASSWORD", "EXPIRE", "LOCK", "UNLOCK", "ACCOUNT",
                "AUDIT", "NOAUDIT", "COMMENT", "RENAME", "TRUNCATE", "FLASHBACK",
                "SCN", "TIMESTAMP", "AS", "OF", "VERSIONS", "BETWEEN", "MINVALUE",
                "MAXVALUE", "START", "END", "XID", "COMMIT", "ROLLBACK", "SAVEPOINT",
                "SET", "TRANSACTION", "READ", "WRITE", "ONLY", "ISOLATION", "LEVEL",
                "SERIALIZABLE", "REPEATABLE", "READ", "COMMITTED", "UNCOMMITTED",
                "AUTOCOMMIT", "CONSTRAINT", "DEFERRABLE", "INITIALLY", "DEFERRED",
                "IMMEDIATE", "NOVALIDATE", "VALIDATE", "USING", "ENABLE", "DISABLE",
                "CASCADE", "EXCEPTIONS", "INTO", "LOG", "ERRORS", "REJECT", "LIMIT",
                "SKIP", "UNUSABLE", "INVISIBLE", "VISIBLE", "IDENTITY", "ALWAYS",
                "GENERATED", "BY", "DEFAULT", "ON", "NULL"
            },
            "postgres": {
                "RETURNING", "ILIKE", "CROSS", "LATERAL", "WINDOW", "PARTITION", "OVER",
                "RANK", "DENSE_RANK", "ROW_NUMBER", "NTILE", "LEAD", "LAG",
                "FIRST_VALUE", "LAST_VALUE", "NTH_VALUE", "CUME_DIST", "PERCENT_RANK",
                "PERCENTILE_CONT", "PERCENTILE_DISC", "WITHIN", "GROUP", "FILTER",
                "DISTINCT", "ON", "UNNEST", "ARRAY", "UNNEST", "VALUES", "ROWS",
                "RANGE", "GROUPS", "BETWEEN", "UNBOUNDED", "PRECEDING", "FOLLOWING",
                "CURRENT", "ROW", "EXCLUDE", "TIES", "GROUP", "NO", "OTHERS",
                "VACUUM", "ANALYZE", "EXPLAIN", "PLAN", "SHOW", "SET", "RESET",
                "WORK", "TRANSACTION", "ISOLATION", "LEVEL", "SERIALIZABLE",
                "REPEATABLE", "READ", "COMMITTED", "UNCOMMITTED", "READ", "WRITE",
                "NOT", "DEFERRABLE", "DEFERRABLE", "INITIALLY", "IMMEDIATE",
                "DEFERRED", "LANGUAGE", "PLPGSQL", "SQL", "VOLATILE", "STABLE",
                "IMMUTABLE", "CALLED", "ON", "NULL", "INPUT", "RETURNS", "NULL",
                "STRICT", "SECURITY", "INVOKER", "DEFINER", "COST", "ROWS", "SET",
                "FROM", "CURRENT", "SESSION", "LOCAL", "GLOBAL", "TEMP", "TEMPORARY",
                "UNLOGGED", "WITH", "OIDS", "WITHOUT", "OIDS", "TABLESPACE", "STORAGE",
                "PLAIN", "EXTERNAL", "EXTENDED", "MAIN", "FILLFACTOR", "TOAST",
                "TABLESPACE", "CLUSTER", "USING", "INDEX", "DROP", "CASCADE",
                "RESTRICT", "OWNER", "TO", "ALTER", "SCHEMA", "ROLE", "USER",
                "GROUP", "ADMIN", "OPTION", "INHERIT", "LOGIN", "SUPERUSER",
                "CREATEDB", "CREATEROLE", "REPLICATION", "BYPASSRLS", "CONNECTION",
                "LIMIT", "PASSWORD", "ENCRYPTED", "VALID", "UNTIL", "IN", "ROLE",
                "GRANT", "REVOKE", "GRANTED", "BY", "PUBLIC", "ALL", "PRIVILEGES",
                "SEQUENCE", "USAGE", "DOMAIN", "TYPE", "ENUM", "RANGE", "COMPOSITE",
                "BASE", "ARRAY", "COLLATION", "OPERATOR", "CLASS", "FAMILY",
                "PROCEDURAL", "LANGUAGE", "TRUSTED", "HANDLER", "VALIDATOR", "INLINE",
                "FUNCTION", "CALL", "VOLATILE", "STABLE", "IMMUTABLE", "STRICT",
                "CALLED", "ON", "NULL", "INPUT", "RETURNS", "NULL", "ON", "NULL",
                "OUTPUT", "WINDOW", "PARALLEL", "UNSAFE", "SAFE", "RESTRICTED",
                "LEAKPROOF", "SECURITY", "DEFINER", "INVOKER", "COST", "ROWS",
                "SET", "CONFIGURATION", "FROM", "CURRENT", "DEFAULT"
            },
            "sqlserver": {
                "TOP", "PERCENT", "WITH", "TIES", "NOLOCK", "HOLDLOCK", "UPDLOCK",
                "TABLOCK", "TABLOCKX", "PAGLOCK", "ROWLOCK", "XLOCK", "NOLOCK",
                "READPAST", "READCOMMITTED", "READUNCOMMITTED", "REPEATABLEREAD",
                "SERIALIZABLE", "SNAPSHOT", "NOEXPAND", "INDEX", "FORCESEEK",
                "FAST", "FIRST", "FASTFIRSTROW", "FORCEORDER", "ROBUST", "PLAN",
                "MAXDOP", "LOOP", "HASH", "MERGE", "OPTIMIZE", "FOR", "RECOMPILE",
                "KEEPFIXED", "PLAN", "KEEPPLAN", "PARAMETERIZATION", "SIMPLE",
                "FORCED", "UNKNOWN", "OPTION", "MAXRECURSION", "QUERYTRACEON",
                "USE", "PLAN", "TABLE", "HINT", "DROPCLEANBUFFERS", "FREEPROCCACHE",
                "CHECKPOINT", "DBCC", "SHOWCONTIG", "INDEXDEFRAG", "UPDATEUSAGE",
                "INPUTBUFFER", "OUTPUTBUFFER", "SQLPERF", "TRACEOFF", "TRACEON",
                "TRACESTATUS", "DATABASE", "SET", "ARITHABORT", "ARITHIGNORE",
                "ANSI_NULLS", "ANSI_NULL_DFLT_OFF", "ANSI_NULL_DFLT_ON",
                "ANSI_PADDING", "ANSI_WARNINGS", "CONCAT_NULL_YIELDS_NULL",
                "CURSOR_CLOSE_ON_COMMIT", "DATEFORMAT", "DATEFIRST", "DEADLOCK_PRIORITY",
                "FIPS_FLAGGER", "IDENTITY_INSERT", "LANGUAGE", "LOCK_TIMEOUT",
                "NOCOUNT", "NOEXEC", "NUMERIC_ROUNDABORT", "PARSEONLY",
                "QUERY_GOVERNOR_COST_LIMIT", "QUOTED_IDENTIFIER", "REMOTE_PROC_TRANSACTIONS",
                "ROWCOUNT", "TEXTSIZE", "TRANSACTION", "ISOLATION", "LEVEL",
                "READ", "UNCOMMITTED", "COMMITTED", "REPEATABLE", "READ", "SERIALIZABLE",
                "SNAPSHOT", "XACT_ABORT", "BEGIN", "COMMIT", "ROLLBACK", "TRAN",
                "TRANSACTION", "WORK", "SAVE", "TRANSACTION", "MARK", "DESCRIPTION",
                "WAITFOR", "DELAY", "TIME", "BREAK", "GOTO", "RETURN", "THROW",
                "TRY_CATCH", "TRY_CONVERT", "FORMATMESSAGE", "XACT_STATE",
                "NEWSEQUENTIALID", "NEWID", "SCOPE_IDENTITY", "IDENT_CURRENT",
                "ROWCOUNT_BIG", "ERROR_NUMBER", "ERROR_SEVERITY", "ERROR_STATE",
                "ERROR_PROCEDURE", "ERROR_LINE", "ERROR_MESSAGE", "IIF", "CHOOSE",
                "ISNULL", "COALESCE", "NULLIF", "ISDATE", "ISNUMERIC", "CONVERT",
                "CAST", "PARSE", "TRY_PARSE", "TRY_CONVERT", "DATEADD", "DATEDIFF",
                "DATENAME", "DATEPART", "DAY", "MONTH", "YEAR", "GETDATE", "GETUTCDATE",
                "CURRENT_TIMESTAMP", "SYSDATETIME", "SYSUTCDATETIME", "SYSDATETIMEOFFSET",
                "SWITCHOFFSET", "TODATETIMEOFFSET", "EOMONTH", "FROMPARTS",
                "TIMEFROMPARTS", "DATETIME2FROMPARTS", "DATETIMEOFFSETFROMPARTS",
                "SMALLDATETIMEFROMPARTS", "DATEFROMPARTS", "DATETIMEFROMPARTS",
                "CHAR", "VARCHAR", "TEXT", "NCHAR", "NVARCHAR", "NTEXT", "BINARY",
                "VARBINARY", "IMAGE", "BIT", "TINYINT", "SMALLINT", "INT", "BIGINT",
                "DECIMAL", "NUMERIC", "MONEY", "SMALLMONEY", "FLOAT", "REAL",
                "DATE", "TIME", "DATETIME", "DATETIME2", "SMALLDATETIME",
                "DATETIMEOFFSET", "TIMESTAMP", "ROWVERSION", "UNIQUEIDENTIFIER",
                "SQL_VARIANT", "XML", "HIERARCHYID", "GEOMETRY", "GEOGRAPHY"
            }
        }
        
        return dialect_specific.get(self.dialect, set())
